...
public class ShiftAlgorithm implements Algorithm {
  ...
  /**
   * <p>
   * <a href="#{@link}">{@link ShiftAlgorithm}</a> is an algorithm, that encrypts a message
   ...
   *
   * @param message
   *     data that are going to be encrypted
   * @param key
   *     offset (key), by which letters will be shifted.
   *
   ...
   *
   * @param message
   *     encrypted data that are going to be decrypted
   * @param key
   *     offset, by which letters were shifted
   *
